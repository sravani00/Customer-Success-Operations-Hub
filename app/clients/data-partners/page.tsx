        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-0.5">
              Consumer data providers, API enrichment services, and real-time validation feeds
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {dataPartners.map((client) => {
          ...
          return (
            <div 
              key={client.id}
              className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl space-y-4 hover:border-purple-500/40 transition-all flex flex-col justify-between"
            >
              <div className="space-y-4">
                <div className="flex items-start justify-between">
                  <div className="flex items-center space-x-3">
                    <div className="w-11 h-11 rounded-xl bg-gradient-to-tr from-purple-600 to-indigo-600 text-white font-bold flex items-center justify-center text-sm shadow-md">
                ...
                <div className="p-2.5 bg-slate-950/40 rounded-xl border border-slate-800 flex items-center justify-between text-xs">
                  <span className="text-slate-400">Integration Feed Status:</span>
                  <span className="font-bold text-purple-300 font-mono">{client.metricsSummary}</span>
                </div>
              </div>
              ...
              <div className="pt-3 border-t border-slate-800/80 flex items-center justify-between">
                ...
                <Link
                  ...
                  className="px-3.5 py-1.5 rounded-lg bg-purple-600/20 hover:bg-purple-600/30 text-purple-300 border border-purple-500/30 text-xs font-semibold flex items-center space-x-1.5 transition-colors"
                >
