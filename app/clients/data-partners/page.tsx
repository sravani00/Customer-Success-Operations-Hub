      ...
      {dataPartners.length === 0 ? (
        <div className="bg-white border border-slate-200/90 rounded-2xl p-12 text-center shadow-xs flex flex-col items-center justify-center space-y-4">
          ...
          <div className="max-w-md space-y-1.5">
            <h3 className="text-base font-bold text-slate-900">No Data Partner accounts yet</h3>
            <p className="text-xs text-slate-500 leading-relaxed">
              Add your first Data Partner account to start tracking account details, revenue, feeds, agreements and activity.
            </p>
          </div>
          <button
            onClick={() => setIsAddModalOpen(true)}
            className="px-4 py-2 rounded-xl bg-purple-600 hover:bg-purple-700 text-white text-xs font-bold flex items-center space-x-1.5 shadow-xs transition-all"
          >
            <Plus className="w-4 h-4" />
            <span>Add Data Partner Account</span>
          </button>
