...
export default function RevShareDataPartnersPage() {
  ...
  const revShareClients = clients.filter((c) => 
    c.subModule === 'Data Partner' && c.subModuleCategory === 'Rev-Share'
  );
          ...
          <div>
            ...
            <h1 className="text-2xl font-bold text-slate-900 tracking-tight flex items-center gap-2">
              ...
              <span className="text-xs px-2.5 py-0.5 rounded-full bg-purple-50 text-purple-700 border border-purple-200 font-mono font-bold">
                {revShareClients.length} Accounts
              </span>
            </h1>
            <p className="text-xs text-slate-500 mt-0.5">
              Revenue-share data monetization partnerships, API commission tracking, and joint data pools
            </p>
          </div>
        </div>
      </div>
            ...
            >
              <div className="space-y-4">
                ...
                <div className="p-2.5 bg-slate-50 rounded-xl border border-slate-200 flex items-center justify-between text-xs">
                  <span className="text-slate-500">Rev-Share Terms:</span>
