      ...
      {janetClients.length === 0 ? (
        <div className="bg-white border border-slate-200/90 rounded-2xl p-12 text-center shadow-xs flex flex-col items-center justify-center space-y-4">
          ...
          <div className="max-w-md space-y-1.5">
            <h3 className="text-base font-bold text-slate-900">No Janet accounts yet</h3>
            <p className="text-xs text-slate-500 leading-relaxed">
              Add your first Janet account to start tracking account details, revenue, feeds, agreements and activity.
            </p>
          </div>
          <button
            onClick={() => setIsAddModalOpen(true)}
